...
[![Travis branch](https://img.shields.io/travis/monolambda/tslit-config-monolambda/master.svg)](https://travis-ci.org/monolambda/tslint-config-monolambda.svg?branch=master)
